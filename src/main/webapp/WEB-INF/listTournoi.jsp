...
<a class="btn btn-primary" href="/tennis/ajoutertournoi" role="button">Ajouter un tournoi</a>
<a class="btn btn-primary" href="/tennis/listTournoi" role="button">Afficher tous les tournois</a>
</div>
...
<table class="table">
  ...
  <tbody>
   <c:forEach items="${liste}" var="tournoi">
    <tr>
	  ...
	  <td>
		...
		data-id="${tournoi.id}" data-name="${tournoi.nom}" data-annee="${tournoi.annee}">Supprimer</button>
	  </td>
    </tr>
    </c:forEach>
  </tbody>
