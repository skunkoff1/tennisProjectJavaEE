...
<body>
	...
	<div class="add-container">
		<form class="form-group" method="post" action="ajouterjoueur">
			<h1 class="h3 mb-3 font-weight-normal" style="color: #FFF;">Match
				final</h1>
			...
			<div class="displayPlayer">
				...
				<div class="playerName">
					<h4>
						<c:out value="${joueurs[0].nom}" />
					</h4>
					<h4>
						<c:out value="${joueurs[0].prenom}" />
					</h4>
				</div>
			</div>
			<div class="displayPlayer">
				...
				<div class="playerName">
					<h4>
						<c:out value="${joueurs[1].nom}" />
					</h4>
					<h4>
						<c:out value="${joueurs[1].prenom}" />
					</h4>
				</div>
			</div>
			<div id="buttonDiv2">
				<a class="cancelLink" href="/tennis/listTournoi" role="button">Retour
					à la liste</a>
			</div>
		</form>
	</div>
