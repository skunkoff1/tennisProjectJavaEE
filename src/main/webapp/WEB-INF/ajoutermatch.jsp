	...
	<div class="add-container">
		<form class="form-group" method="post" action="ajouterjoueur">
			...
			<div class="input-group mb-3">
				<label for="playerName" class="label">Nom du Joueur</label> <input
					type="text" name="playerName" class="form-control"
			...
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<label class="input-group-text" for="inputGroupSelect01">Sexe
						du joueur</label>
				</div>
