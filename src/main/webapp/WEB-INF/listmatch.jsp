...
<a type="submit" class="btn btn-primary" href="/tennis/listmatch?mode=all&search=${search}" role="button">Afficher tous les matchs</a>
<a type="submit" class="btn btn-primary" href="/tennis/listmatch?mode=winner&search=${search}" role="button">Afficher les vainqueurs</a>
<a type="submit" class="btn btn-primary" href="/tennis/listmatch?mode=final&search=${search}" role="button">Afficher les finalistes</a>
<a type="submit" class="btn btn-primary" href="/tennis/listmatch?mode=all&search=" role="button">Réinitialiser</a>
</div>
